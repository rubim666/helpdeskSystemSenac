      ...
      <header>
        ...
        <figure>
          ...
          <img
            ...
            src="../../assets/img/support-person-svgrepo-com.svg"
            alt=""
          />
          <figcaption>
      ...
      <section className="sidebar__wrapper">
        <ul className="sidebar__list list--primary">
          ...
          <li className="sidebar__item">
            {" "}
            <a className="sidebar__link" href="#" data-tooltip="Inbox">
              {" "}
              <span className="icon">
                {" "}
                <svg
          ...
          <li className="sidebar__item">
            {" "}
            <a className="sidebar__link" href="#" data-tooltip="Sent">
              {" "}
              <span className="icon">
                {" "}
                <svg
          ...
          <li className="sidebar__item">
            {" "}
            <a className="sidebar__link" href="#" data-tooltip="Draft">
              {" "}
              <span className="icon">
                {" "}
                <svg
          ...
          <li className="sidebar__item">
            {" "}
            <a className="sidebar__link" href="#" data-tooltip="Archive">
              {" "}
              <span className="icon">
                {" "}
                <svg
          ...
          <li className="sidebar__item">
            {" "}
            <a className="sidebar__link" href="#" data-tooltip="Trash">
              {" "}
              <span className="icon">
                {" "}
                <svg
